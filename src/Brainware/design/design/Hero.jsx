...
export const Gradient = () => {
  return (
    <>
      <div className="relative  h-6 mx-2.5 bg-n-11 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-8" />
...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[42.375rem]  left-1/2 opacity-10 w-[60rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2  xl:-top-[2rem] max-sm:w-[5rem] max-sm:-top[15rem] ">
     

      {/* Moving background colored circle balls */}
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        <div className="absolute opacity-10   bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[46deg]">
          <div
